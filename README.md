...
## OpenQBMM-validation repository

The OpenQBMM-validation repository contains tests to validate parts of OpenQBMM.

The validation cases contained in this repository require the source code of the 
main OpenQBMM repository and of the OpenQBMM-test repository to be available and
compiled on the machine where the tests are executed.
